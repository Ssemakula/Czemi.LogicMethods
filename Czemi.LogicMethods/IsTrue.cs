...
namespace Czemi.LogicMethods
{
    public static partial class Logic
    {
        ...
        public static bool IsTrue(this uint? value) => value != null && value != 0U;

        public static bool IsTrue(this long? value) => value != null && value != 0L;
        public static bool IsTrue(this ulong? value) => value != null && value != 0UL;

        public static bool IsTrue(this short? value) => value != null && value != 0;

        public static bool IsTrue(this ushort? value) => value != null && value != 0;
        public static bool IsTrue(this BigInteger? value) => value != null && value != 0;

        public static bool IsTrue(this byte? value) => value != null && value != 0;

        public static bool IsTrue(this sbyte? value) => value != null && value != 0;

        public static bool IsTrue(this float? value) => value != null && value != 0f;

        public static bool IsTrue(this double? value) => value != null && value != 0d;
        public static bool IsTrue(this decimal? value) => value != null && value != 0m;
